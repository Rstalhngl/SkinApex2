...
function InventoryCard({
  ...
  return (
    <div
      className="relative flex h-[165px] flex-col overflow-hidden rounded-lg border border-border bg-card p-3 transition-all duration-200 hover:border-[#243146] hover:shadow-lg"
    ...
    >
      ...
      {/* Image */}
      <div
        className="flex h-[75px] items-center justify-center transition-transform duration-200"
        style={{ transform: hovered ? "scale(0.95)" : "scale(1)" }}
      >
      ...
      {/* Info */}
      <div
        className="mt-auto min-w-0 z-10 transition-opacity duration-200"
      ...
      {/* Hover actions */}
      <div
        className="absolute inset-0 flex flex-col items-center justify-center gap-1.5 bg-card/95 px-2.5 transition-opacity duration-200 z-20"
        style={{
          opacity: hovered ? 1 : 0,
